        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 info-area-right">
                ...
                <p>inappropriate behavior is often laughed off as “boys will be boys,” women face higher conduct
                    ...
                    job is beyond reproach.</p>
                <br>
                <p>
                    inappropriate behavior is often laughed off as “boys will be boys,” women face higher conduct
                    standards especially in the workplace. That’s why it’s crucial that, as women, our behavior on the
                    job is beyond reproach. inappropriate behavior is often laughed off as “boys will be boys,” women
                    face higher conduct standards especially in the workplace. That’s why it’s crucial that, as women,
...
<section class="project p-5" style="background-color: #f4f4f4">
    <div class="container text-center p-3 mb-">
        <div class="text-center">
            <h1 class="mb-3">Our reach</h1>
            <div class="row mb-5">
                <div class="col-2">
                </div>
                <div class="col-8">
                    <h5>Udemy is the leading global marketplace for teaching and learning, connecting millions of
                        students to the skills they need to succeed.</h5>
                </div>
                <div class="col-">
                </div>
            </div>
        ...
        <div class="row mb-5">
            <div class="col-sm-3 col-12">
                <div>
                    <i class="fas fa-user-graduate mb-4" style="color: #f7631b; font-size: 3rem"></i><br>
                    <span class="count" style="font-size: 1.5rem; font-weight: bold">1500</span><span
                            style="font-size: 1.5rem; font-weight: bold">k</span>
                    <p class="mt-2" style="font-size: 1.5rem;">Student</p>
                </div>
            </div>
            <div class="col-sm-3 col-12">
                <div>
                    <i class="fas fa-book-open mb-4" style="color: #f7631b; font-size: 3rem"></i><br>
                    <span class="count" style="font-size: 1.5rem; font-weight: bold">10</span><span
                            style="font-size: 1.5rem; font-weight: bold">k</span>
                    <p class="mt-2" style="font-size: 1.5rem;">Courses</p>
                </div>
            </div>
            <div class="col-sm-3 col-12">
                <div>
                    <i class="fas fa-video mb-4" style="color: #f7631b; font-size: 3rem"></i><br>
                    <span class="count" style="font-size: 1.5rem; font-weight: bold">2500</span><span
                            style="font-size: 1.5rem; font-weight: bold">k</span>
                    <p class="mt-2" style="font-size: 1.5rem;">Video</p>
                </div>
            </div>
            <div class="col-sm-3 col-12">
                <div>
                    <i class="fas fa-award mb-4" style="color: #f7631b; font-size: 3rem"></i><br>
...
<!-- start footer Area -->
<footer class="footer-area section-gap p-5 ">
    <div class="container">
        <div class="row">
